 ...
 */
export declare function classifyChunks(config: ChunkClassificationConfig, result?: ExtractedDocument | undefined | null): Promise<void>;
...
export interface ChunkingConfig {
   ...
   * Default: `Content`.
   */
  readonly breadcrumbTarget?: BreadcrumbTarget
}
...
export type OcrStrategy =
  | { mode: 'auto' }
  | { mode: 'scanned_pages'; minConfidence: number }
...
export type RerankerModelType =
  | { type: 'preset'; name: string }
  | { type: 'custom'; modelId: string; modelFile: string; additionalFiles: Array<string>; maxLength: number; head: RerankerHead }
  | { type: 'llm'; llm: LlmConfig }
  | { type: 'plugin'; name: string }
