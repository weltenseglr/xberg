...
import { Content as Snip_wasm_getting_started_runtime_detection } from "../../../snippets/wasm/getting-started/runtime-detection.md";
...
The package reports the host runtime and its Wasm capabilities. Read them before you call `initWasm` if your code must branch on workers or `SharedArrayBuffer`:

<Snip_wasm_getting_started_runtime_detection />
