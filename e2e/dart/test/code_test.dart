...
void main() {
  ...
  test('Test language detection from shebang line via bytes input', () async {
    final _inputMockBaseUrl = _fixtureUrl("code_shebang_detection");
    final _inputJson = '{"kind":"uri","mime_type":"text/x-source-code","uri":"\$mock_url/code/script.sh"}'.replaceAll(r'$mock_url', _inputMockBaseUrl);
    ...
    expect(result.results[0].mimeType.toString(), equals('text/x-source-code'.toString()));
