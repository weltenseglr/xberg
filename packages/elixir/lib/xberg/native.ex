...
defmodule Xberg.Native do
  ...
  """
  def ensure_initialized, do: :erlang.nif_error(:nif_not_loaded)
  ...
  * `source_text` - The full source text to search
  ...
  """
  def doctor(_config), do: :erlang.nif_error(:nif_not_loaded)
  ...
  **Opt-in.** Nothing calls this automatically, and that is deliberate: xberg
  ...
  """
  def install_pdf_render_diagnostics, do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def take_pdf_oxide_render_warnings, do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def build_decoder_prompt_tokens(_start_of_transcript, _lang_id, _transcribe, _no_timestamps, _timestamps),
  ...
  """
  def timestamp_token_to_ms(_token_id, _timestamp_begin_id), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def llmconfig_validate(_obj), do: :erlang.nif_error(:nif_not_loaded)
  ...
  * `version` - `"pp-ocrv6"` (default) or `"pp-ocrv5"`. Under `"pp-ocrv6"`, `model_tier`
  ...
  @doc false
  def csv_config_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  ...
  @doc false
  def llm_provider_config_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)

  @doc false
  def llm_cache_config_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)

  @doc false
  def llm_budget_config_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)

  @doc false
  def llm_rate_limit_config_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)

  @doc false
  def bedrock_config_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  ...
  @doc false
  def language_confidence_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  ...
  @doc false
  def doctor_check_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)

  @doc false
  def doctor_report_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
