...
public sealed class ChunkingReasonJsonConverter : JsonConverter<ChunkingReason>
{
    public override ChunkingReason Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "LargeFile" =>
                JsonSerializer.Deserialize<ChunkingReason.LargeFile>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "ManyPages" =>
            ...
            "OcrRequired" =>
                JsonSerializer.Deserialize<ChunkingReason.OcrRequired>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "LargeAndManyPages" =>
                JsonSerializer.Deserialize<ChunkingReason.LargeAndManyPages>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
