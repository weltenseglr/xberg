...
public sealed class RevisionAnchorJsonConverter : JsonConverter<RevisionAnchor>
{
    public override RevisionAnchor Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "paragraph" =>
                JsonSerializer.Deserialize<RevisionAnchor.Paragraph>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "table_cell" =>
                JsonSerializer.Deserialize<RevisionAnchor.TableCell>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "page" =>
                JsonSerializer.Deserialize<RevisionAnchor.Page>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "slide" =>
                JsonSerializer.Deserialize<RevisionAnchor.Slide>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "sheet" =>
                JsonSerializer.Deserialize<RevisionAnchor.Sheet>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
