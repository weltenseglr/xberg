...
public sealed class ImageOutputFormatJsonConverter : JsonConverter<ImageOutputFormat>
{
    public override ImageOutputFormat Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return tagValue switch
        {
            ...
            "png" =>
                new ImageOutputFormat.Png(),
            "jpeg" =>
                JsonSerializer.Deserialize<ImageOutputFormat.Jpeg>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "webp" =>
                JsonSerializer.Deserialize<ImageOutputFormat.Webp>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "heif" =>
                JsonSerializer.Deserialize<ImageOutputFormat.Heif>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "svg" =>
                new ImageOutputFormat.Svg(),
