...
public sealed class RerankerModelTypeJsonConverter : JsonConverter<RerankerModelType>
{
    public override RerankerModelType Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "preset" =>
                JsonSerializer.Deserialize<RerankerModelType.Preset>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "custom" =>
                JsonSerializer.Deserialize<RerankerModelType.Custom>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "llm" =>
                JsonSerializer.Deserialize<RerankerModelType.Llm>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "plugin" =>
                JsonSerializer.Deserialize<RerankerModelType.Plugin>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
