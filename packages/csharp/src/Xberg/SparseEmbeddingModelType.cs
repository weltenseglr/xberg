...
public sealed class SparseEmbeddingModelTypeJsonConverter : JsonConverter<SparseEmbeddingModelType>
{
    public override SparseEmbeddingModelType Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "preset" =>
                JsonSerializer.Deserialize<SparseEmbeddingModelType.Preset>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "custom" =>
                JsonSerializer.Deserialize<SparseEmbeddingModelType.Custom>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "plugin" =>
                JsonSerializer.Deserialize<SparseEmbeddingModelType.Plugin>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
