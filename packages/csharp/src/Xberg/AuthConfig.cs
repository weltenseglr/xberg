...
public sealed class AuthConfigJsonConverter : JsonConverter<AuthConfig>
{
    public override AuthConfig Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "basic" =>
                JsonSerializer.Deserialize<AuthConfig.Basic>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "bearer" =>
                JsonSerializer.Deserialize<AuthConfig.Bearer>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "header" =>
                JsonSerializer.Deserialize<AuthConfig.Header>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
