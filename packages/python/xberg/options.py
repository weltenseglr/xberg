...
class ChunkingConfig:
    ...
    """**Deprecated and inert** (#1393): no longer prepends anything into `content`. Setting this field has no observable effect on chunking output any more."""
    ...
    breadcrumb_target: BreadcrumbTarget | str = "content"

    """**Deprecated and inert** (#1393): see [`BreadcrumbTarget`](crate::core::config::extraction::BreadcrumbTarget) for the full explanation. Neither variant has any effect on `content` any more -- call [`render_heading_breadcrumb`](crate::chunking::render_heading_breadcrumb) explicitly at index time instead. Kept only for backward compatibility."""
...
def _from_native_chunking_config(native: Any) -> ChunkingConfig:
    ...
    return ChunkingConfig(
        ...
        sparse_embedding=(None if native.sparse_embedding is None else _from_native_sparse_embedding_config(native.sparse_embedding)),
        late_interaction=(None if native.late_interaction is None else _from_native_late_interaction_config(native.late_interaction)),
        ...
        breadcrumb_target=native.breadcrumb_target,
    )
